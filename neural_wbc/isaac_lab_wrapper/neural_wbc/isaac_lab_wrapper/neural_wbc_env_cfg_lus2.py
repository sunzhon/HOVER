...
class NeuralWBCEnvCfgLus2(NeuralWBCEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.reference_motion_manager.motion_path = get_data_path("motions/Select.pkl")
        self.reference_motion_manager.skeleton_path = get_data_path("motion_lib/lus2_joint27.xml")
